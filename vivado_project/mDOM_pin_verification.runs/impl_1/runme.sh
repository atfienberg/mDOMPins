...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/pinAssign/vivado_project/mDOM_pin_verification.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mDOM_pin_verification_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mDOM_pin_verification_top.tcl -notrace
