...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/pinAssign/vivado_project/mDOM_pin_verification.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mDOM_pin_verification_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mDOM_pin_verification_top.tcl
