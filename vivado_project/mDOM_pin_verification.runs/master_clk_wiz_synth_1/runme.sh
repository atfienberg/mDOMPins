...
HD_PWD='C:/Users/atfie/IceCube/mDOMDevelopment/pinAssign/vivado_project/mDOM_pin_verification.runs/master_clk_wiz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_clk_wiz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_clk_wiz.tcl
