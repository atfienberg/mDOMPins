...
synth_design -top mDOM_pin_verification_top -part xc7s100fgga676-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef mDOM_pin_verification_top.dcp
create_report "synth_2_synth_report_utilization_0" "report_utilization -file mDOM_pin_verification_top_utilization_synth.rpt -pb mDOM_pin_verification_top_utilization_synth.pb"
